...
void AT_gamma_response( const long  number_of_doses,
  ...
  /*
   *  (7) Multi-component model as given in Geiß, 1997 (PhD thesis)
   *
   ...
   *                 k1 - contribution from linear component (0.8 for Geiß, 1997)
   *                 a1 - dose prefactor for linear component (3e-4 for Geiß, 1997)
   *                 k2 - contribution from quadratic component (0.2 for Geiß, 1997)
   *                 a2 - dose prefactor for quadratic component (1e-6 for Geiß, 1997)
   **/
