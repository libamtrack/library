...
Remove all files from war directory in test project:

rm -rf webapps/test/*

Put all the contents of war directory with newly compiled project
to the webapps/test directory on the server.

Start jetty again:

/usr/lib/jvm/java-6-sun-1.6.0.20/bin/java -jar start.jar
...
To launch your web app in GWT development mode, go to the Run menu and choose:
  ...
  named "AmtrackService".  Select and click "Debug".
