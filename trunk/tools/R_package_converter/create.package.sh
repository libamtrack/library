...
R CMD check libamtrack_0.4.1.tar.gz --no-latex # this command produce directory with R package
rm libamtrack_0.4.1.tar.gz # let us remove this file as this is not really a R package
rm package/src/*.h
rm package/src/*.c
