...
CFLAGS    = -Wall -c -O3 -std=gnu99 -DNDEBUG
...
LIBCOBJS  = $(SRCDIR)$(DSEP)AT.c $(SRCDIR)$(DSEP)AT_Algorithms_CPP.c $(SRCDIR)$(DSEP)AT_Algorithms_IGK.c $(SRCDIR)$(DSEP)AT_Error.c $(SRCDIR)$(DSEP)AT_Constants.c $(SRCDIR)$(DSEP)AT_GammaResponse.c $(SRCDIR)$(DSEP)AT_DataStoppingPower.c $(SRCDIR)$(DSEP)AT_DataRange.c $(SRCDIR)$(DSEP)AT_DataLET.c $(SRCDIR)$(DSEP)AT_DataMaterial.c $(SRCDIR)$(DSEP)AT_DataParticle.c $(SRCDIR)$(DSEP)AT_ElectronRange.c $(SRCDIR)$(DSEP)AT_GammaResponse.c $(SRCDIR)$(DSEP)AT_NumericalRoutines.c $(SRCDIR)$(DSEP)AT_PhysicsRoutines.c $(SRCDIR)$(DSEP)AT_RDD.c $(SRCDIR)$(DSEP)AT_RDD_Simple.c $(SRCDIR)$(DSEP)AT_RDD_ShellAveraged.c $(SRCDIR)$(DSEP)AT_RDD_ExtendedTarget.c $(SRCDIR)$(DSEP)AT_KatzModel.c $(SRCDIR)$(DSEP)AT_SuccessiveConvolutions.c $(SRCDIR)$(DSEP)AT_Histograms.c $(SRCDIR)$(DSEP)AT_Algorithms_GSM.c $(SRCDIR)$(DSEP)AT_SPC.c

LIBHOBJS  = $(INCLDIR)$(DSEP)AT.h $(INCLDIR)$(DSEP)AT_Algorithms_CPP.h $(INCLDIR)$(DSEP)AT_Algorithms_IGK.h $(INCLDIR)$(DSEP)AT_Error.h $(INCLDIR)$(DSEP)AT_Constants.h $(INCLDIR)$(DSEP)AT_GammaResponse.h $(INCLDIR)$(DSEP)AT_DataStoppingPower.h $(INCLDIR)$(DSEP)AT_DataRange.h $(INCLDIR)$(DSEP)AT_DataLET.h $(INCLDIR)$(DSEP)AT_DataMaterial.h $(INCLDIR)$(DSEP)AT_DataParticle.h $(INCLDIR)$(DSEP)AT_ElectronRange.h $(INCLDIR)$(DSEP)AT_GammaResponse.h $(INCLDIR)$(DSEP)AT_NumericalRoutines.h $(INCLDIR)$(DSEP)AT_PhysicsRoutines.h $(INCLDIR)$(DSEP)AT_RDD.h $(INCLDIR)$(DSEP)AT_RDD_Simple.h $(INCLDIR)$(DSEP)AT_RDD_ShellAveraged.h $(INCLDIR)$(DSEP)AT_RDD_ExtendedTarget.h $(INCLDIR)$(DSEP)AT_KatzModel.h $(INCLDIR)$(DSEP)AT_SuccessiveConvolutions.h $(INCLDIR)$(DSEP)AT_Histograms.h $(INCLDIR)$(DSEP)AT_Algorithms_GSM.h $(INCLDIR)$(DSEP)AT_SPC.h

LIBOBJS  = AT.o AT_Algorithms_CPP.o AT_Algorithms_IGK.o AT_Error.o AT_Constants.o AT_DataStoppingPower.o AT_DataRange.o AT_DataLET.o AT_DataMaterial.o AT_DataParticle.o AT_ElectronRange.o AT_GammaResponse.o AT_NumericalRoutines.o AT_PhysicsRoutines.o AT_RDD.o AT_RDD_Simple.o AT_RDD_ShellAveraged.o AT_RDD_ExtendedTarget.o AT_SuccessiveConvolutions.o AT_KatzModel.o AT_Histograms.o AT_Algorithms_GSM.o AT_SPC.o
...
binary-linux:$(LIBCOBJS) $(LIBHOBJS)
		...
		cp ./README bin$(DSEP)dynamic
		cp ./README bin$(DSEP)static
		cp ./COPYING bin$(DSEP)dynamic
		cp ./COPYING bin$(DSEP)static
